...
import { CheckCircle, XCircle, AlertTriangle, Brain, Users, GraduationCap, Pill, ArrowRight, ArrowLeft, Shield, Baby } from "lucide-react"
      ...
      <div className="relative bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-100 dark:from-slate-900 dark:via-purple-900/20 dark:to-indigo-900/30 overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-8 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-3 mb-6">
            {[
              { step: 1, title: "¿Existe realmente?", subtitle: "Realidad del TDAH", icon: Brain },
              { step: 2, title: "¿Solo en niños?", subtitle: "TDAH en adultos", icon: Baby },
              { step: 3, title: "¿Falta de voluntad?", subtitle: "Causa neurológica", icon: XCircle },
              { step: 4, title: "¿Medicamentos peligrosos?", subtitle: "Seguridad tratamiento", icon: Pill },
              { step: 5, title: "¿Solo en varones?", subtitle: "TDAH en mujeres", icon: Users },
              { step: 6, title: "¿Menos inteligentes?", subtitle: "Inteligencia y TDAH", icon: GraduationCap }
            ].map((step) => (
              <button
                key={step.step}
            ...
            <div className="space-y-6">
              <Card className="border-blue-200 dark:border-blue-800 bg-blue-50/30 dark:bg-blue-950/30">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>Separando la realidad científica de las creencias populares</CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="p-4 border-l-4 border-green-500 bg-green-50 dark:bg-green-950">
                      ...
                      <ul className="text-sm space-y-2">
                        <li>• <strong>OMS lo reconoce</strong> como trastorno del neurodesarrollo<CitationLink number={3} /></li>
                        <li>• <strong>Base neurobiológica sólida:</strong> Diferencias cerebrales reales</li>
                        <li>• <strong>Heredabilidad del 70-80%:</strong> Fuerte componente genético</li>
                        <li>• <strong>Consenso médico internacional</strong> de 208 expertos<CitationLink number={3} /></li>
                        <li>• <strong>Investigación de +100 años</strong> desde Still (1902)</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="p-6 bg-blue-50 dark:bg-blue-950 rounded-lg">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      <div className="text-center p-3 bg-white dark:bg-slate-800 rounded">
                        <div className="text-xl font-bold text-blue-500 mb-1">🧠</div>
                        <div className="text-sm font-semibold">Neuroimágenes</div>
                        <div className="text-xs text-muted-foreground">Diferencias en corteza prefrontal</div>
                      </div>
                      <div className="text-center p-3 bg-white dark:bg-slate-800 rounded">
                        <div className="text-xl font-bold text-purple-500 mb-1">⚗️</div>
                        <div className="text-sm font-semibold">Neuroquímica</div>
                        <div className="text-xs text-muted-foreground">Déficit dopamina/noradrenalina</div>
                      </div>
                      <div className="text-center p-3 bg-white dark:bg-slate-800 rounded">
                        <div className="text-xl font-bold text-green-500 mb-1">🧬</div>
                        <div className="text-sm font-semibold">Genética</div>
                        <div className="text-xs text-muted-foreground">Genes específicos identificados</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 text-center">
                    <Button onClick={() => setCurrentStep(2)} size="lg">
                      Siguiente: ¿Solo en niños? <ArrowRight className="h-4 w-4 ml-2" />
                    </Button>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="space-y-6">
              <Card className="border-green-200 dark:border-green-800 bg-green-50/30 dark:bg-green-950/30">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>La realidad del TDAH adulto que muchos desconocen</CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="p-4 border-l-4 border-green-500 bg-green-50 dark:bg-green-950">
                      ...
                      <ul className="text-sm space-y-2">
                        <li>• <strong>45-85% persiste en la adultez</strong> según estudios longitudinales<CitationLink number={2} /></li>
                        <li>• <strong>2.5% de prevalencia</strong> en adultos globalmente</li>
                        <li>• <strong>Evoluciona, no desaparece:</strong> Se adapta a demandas adultas</li>
                        <li>• <strong>Diagnósticos tardíos frecuentes:</strong> Especialmente mujeres</li>
                        <li>• <strong>Impacto severo no tratado:</strong> Trabajo, relaciones, salud</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="text-center p-4 border rounded-lg bg-white dark:bg-slate-800">
                      <div className="text-3xl font-bold text-purple-500 mb-1">1.9:1</div>
                      <div className="text-sm text-muted-foreground">Proporción H:M en adultos</div>
                    </div>
                    <div className="text-center p-4 border rounded-lg bg-white dark:bg-slate-800">
                      <div className="text-3xl font-bold text-green-500 mb-1">30-40</div>
                  ...
                  <Alert>
                    <CheckCircle className="h-4 w-4" />
                    <AlertDescription>
                      <strong>Realidad:</strong> El TDAH adulto es tan real como el infantil. Muchos adultos viven décadas sin diagnóstico, sufriendo problemas en trabajo, relaciones y autoestima que podrían ser tratados efectivamente.
                    </AlertDescription>
                  </Alert>
                  
                  <div className="mt-6 text-center space-x-4">
                    <Button onClick={() => setCurrentStep(3)} size="lg">
                      Siguiente: ¿Falta de voluntad? <ArrowRight className="h-4 w-4 ml-2" />
                    </Button>
            ...
            <div className="space-y-6">
              <Card className="border-purple-200 dark:border-purple-800 bg-purple-50/30 dark:bg-purple-950/30">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>La diferencia entre déficit neurológico y falta de esfuerzo</CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="mt-6 text-center space-x-4">
                    <Button onClick={() => setCurrentStep(4)} size="lg">
                      Siguiente: ¿Medicamentos peligrosos? <ArrowRight className="h-4 w-4 ml-2" />
                    </Button>
            ...
            <div className="space-y-6">
              <Card className="border-orange-200 dark:border-orange-800 bg-orange-50/30 dark:bg-orange-950/30">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>La verdad sobre la seguridad del tratamiento farmacológico</CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="p-4 border-l-4 border-green-500 bg-green-50 dark:bg-green-950">
                      ...
                      <ul className="text-sm space-y-2">
                        <li>• <strong>70+ años de uso seguro:</strong> Desde 1950s, millones de personas</li>
                        <li>• <strong>Reduce riesgo de adicción:</strong> TDAH no tratado 2x más TUS</li>
                        <li>• <strong>Dosis terapéuticas vs. abuso:</strong> Mecanismo completamente diferente</li>
                        <li>• <strong>Mejoran función cerebral:</strong> Normalizan neurotransmisores</li>
                  ...
                  <div className="mt-6 text-center space-x-4">
                    <Button onClick={() => setCurrentStep(5)} size="lg">
                      Siguiente: ¿Solo en varones? <ArrowRight className="h-4 w-4 ml-2" />
                    </Button>
            ...
            <div className="space-y-6">
              <Card className="border-pink-200 dark:border-pink-800 bg-pink-50/30 dark:bg-pink-950/30">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>El TDAH oculto en mujeres: un problema de diagnóstico</CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="p-4 border-l-4 border-green-500 bg-green-50 dark:bg-green-950">
                      ...
                      <ul className="text-sm space-y-2">
                        ...
                        <li>• <strong>Subdiagnóstico masivo:</strong> 4:1 en consultas vs 1.9:1 en adultos</li>
                        <li>• <strong>Presentación diferente:</strong> Más internalizada en mujeres</li>
                        <li>• <strong>Impacto similar o mayor:</strong> Depresión, ansiedad, autoestima</li>
                        <li>• <strong>Diagnósticos tardíos:</strong> Después de los 30-40 años</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 text-center space-x-4">
                    <Button onClick={() => setCurrentStep(6)} size="lg">
                      Siguiente: ¿Menos inteligentes? <ArrowRight className="h-4 w-4 ml-2" />
                    </Button>
            ...
            <div className="space-y-6">
              <Card className="border-indigo-200 dark:border-indigo-800 bg-indigo-50/30 dark:bg-indigo-950/30">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>TDAH e inteligencia: separando capacidad de expresión</CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="p-4 border-l-4 border-green-500 bg-green-50 dark:bg-green-950">
                      ...
                      <ul className="text-sm space-y-2">
                        <li>• <strong>CI normal o superior:</strong> Misma distribución poblacional</li>
                        <li>• <strong>Fortalezas únicas:</strong> Creatividad, pensamiento divergente</li>
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-6">
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <ul className="text-sm space-y-1">
                          <li>• <strong>Regulación:</strong> No inteligencia</li>
                          <li>• <strong>Inconsistencia:</strong> Variable según interés</li>
                          <li>• <strong>Adaptaciones:</strong> Necesarias, no menor exigencia</li>
                        </ul>
                      </CardContent>
                    </Card>
                    ...
                    <Card>
                      <CardHeader>
                        <CardTitle className="text-base">Éxito Profesional</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <ul className="text-sm space-y-1">
                          <li>• <strong>Emprendedores:</strong> Energía e innovación</li>
                          <li>• <strong>Artistas:</strong> Pensamiento divergente</li>
                          <li>• <strong>Crisis/Emergencias:</strong> Funcionan bajo presión</li>
                        </ul>
                      </CardContent>
                    </Card>
                  </div>
                  ...
                  <Alert>
                    <CheckCircle className="h-4 w-4" />
                    <AlertDescription>
                      <strong>Realidad:</strong> El TDAH es una condición médica real, tratable y manejable. 
