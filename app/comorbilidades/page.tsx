...
import { AlertTriangle, Brain, Heart, Activity, Zap, Pill, Users, ArrowRight, ArrowLeft, CheckCircle } from "lucide-react"
          ...
          <CardContent className="space-y-6">
            {currentStep === 1 && (
              <>
                <Card className="border-blue-200 dark:border-blue-800 bg-blue-50/30 dark:bg-blue-950/30">
                  <CardHeader>
                    <CardTitle className="text-base">¿Qué son las comorbilidades?</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-sm mb-4">
                      Las <strong>comorbilidades</strong> son condiciones médicas o psiquiátricas que ocurren junto con el TDAH. 
                      No son causadas por el TDAH, sino que coexisten independientemente, aunque pueden influirse mutuamente.
                    </p>
                    <div className="grid md:grid-cols-2 gap-4 text-sm">
                      <div>
                        <h5 className="font-semibold mb-2">Tipos principales:</h5>
                        <ul className="space-y-1">
                          <li>• <strong>Psiquiátricas:</strong> Ansiedad, depresión, bipolar</li>
                          <li>• <strong>Médicas:</strong> Diabetes, asma, obesidad</li>
                          <li>• <strong>Neurológicas:</strong> Autismo, epilepsia</li>
                        </ul>
                      </div>
                      <div>
                        <h5 className="font-semibold mb-2">¿Por qué son importantes?</h5>
                        <ul className="space-y-1">
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    <strong>Realidad:</strong> Entre el 70% y 80%<CitationLink number={1} /> de las personas con TDAH desarrollan al menos una condición comórbida. 
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-base">Comorbilidades psiquiátricas más frecuentes</CardTitle>
                    </CardHeader>
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-base">Comorbilidades médicas</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-3">
                      <div className="flex justify-between items-center">
            ...
            {currentStep === 2 && (
              <>
                <Alert className="border-amber-200 dark:border-amber-800 bg-amber-50/30 dark:bg-amber-950/30">
                  ...
                  <AlertDescription>
                    <strong>La más común:</strong> 50-60% de adultos con TDAH desarrollan trastornos de ansiedad<CitationLink number={1} />. 
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-base">¿Por qué ocurre?</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <ul className="text-sm space-y-2">
                        <li>• Las dificultades crónicas del TDAH generan preocupación</li>
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-base">Tratamiento recomendado</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-3">
                        ...
                        <div className="p-3 bg-amber-50 dark:bg-amber-950 rounded">
                          <h5 className="font-semibold text-sm mb-1">⚠️ Precaución</h5>
                          <ul className="text-xs space-y-1">
              ...
              <>
                <div className="grid md:grid-cols-3 gap-4 mb-6">
                  <div className="text-center p-4 border rounded-lg bg-blue-50 dark:bg-blue-950">
                    ...
                    <div className="text-xs text-muted-foreground">Prevalencia en adultos</div>
                  </div>
                  <div className="text-center p-4 border rounded-lg bg-green-50 dark:bg-green-950">
                    <div className="text-2xl font-bold text-green-500 mb-1">2x</div>
                    <div className="text-xs text-muted-foreground">Mayor riesgo</div>
                  </div>
                  <div className="text-center p-4 border rounded-lg bg-purple-50 dark:bg-purple-950">
                    ...
                    <div className="text-xs text-muted-foreground">Mejora al tratar TDAH</div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <Card className="border-blue-200 dark:border-blue-800">
                    <CardHeader>
                      <CardTitle className="text-base">Depresión Secundaria (más común)</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm">Surge como resultado de las dificultades crónicas del TDAH: fracasos repetidos, baja autoestima, problemas laborales</p>
                    </CardContent>
                  </Card>

                  <Card className="border-green-200 dark:border-green-800">
                    <CardHeader>
                      <CardTitle className="text-base">Comorbilidad Verdadera</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm">Ambas condiciones coexisten independientemente, cada una requiere tratamiento específico</p>
                    </CardContent>
                  </Card>

                  <Card className="border-purple-200 dark:border-purple-800">
                    <CardHeader>
                      <CardTitle className="text-base">Sintomatología Superpuesta</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm">Dificultades de concentración y motivación pueden confundir el diagnóstico</p>
                    </CardContent>
                  </Card>
                </div>
              </>
            ...
            {currentStep === 4 && (
              <>
                <Alert>
                  ...
                  <AlertDescription>
                    <strong>Diagnóstico dual:</strong> El DSM-5 permite el diagnóstico de TDAH + TEA desde 2013. 
                    29.4% de adolescentes masculinos con TDAH tienen autismo<CitationLink number={1} />.
                  </AlertDescription>
                </Alert>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-base">Características clave</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <ul className="text-sm space-y-2">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-sm mb-4">
                        Para diagnóstico diferencial detallado, tratamiento específico y características completas:
                      </p>
                      <Link 
                        href="/autismo"
            ...
            {currentStep === 5 && (
              <div className="space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle className="text-base">Principios generales</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="text-base">Orden de tratamiento</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="p-3 bg-red-50 dark:bg-red-950 rounded-lg">
                        <h5 className="font-semibold text-sm">🔴 Primera prioridad</h5>
                        <p className="text-xs">Trastorno bipolar, psicosis, ideas suicidas, abuso severo</p>
                      </div>
                      <div className="p-3 bg-amber-50 dark:bg-amber-950 rounded-lg">
                        <h5 className="font-semibold text-sm">🟡 Segunda prioridad</h5>
                        <p className="text-xs">TDAH, depresión mayor, ansiedad severa</p>
                      </div>
                      <div className="p-3 bg-green-50 dark:bg-green-950 rounded-lg">
                        <h5 className="font-semibold text-sm">🟢 Tercera prioridad</h5>
                        <p className="text-xs">Condiciones médicas, trastornos del sueño</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
